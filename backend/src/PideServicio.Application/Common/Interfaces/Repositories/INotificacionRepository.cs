...
public interface INotificacionRepository
{
    ...
    Task<PagedResult<Notificacion>> ListarPorUsuarioAsync(Guid usuarioId, bool? soloNoLeidas, int pagina, int tamanoPagina, Guid? sucursalId = null, CancellationToken ct = default);
    Task<int> ContarNoLeidasAsync(Guid usuarioId, Guid? sucursalId = null, CancellationToken ct = default);
    Task<IReadOnlyList<ConteoPorSucursalItemDto>> ContarNoLeidasPorSucursalAsync(Guid usuarioId, CancellationToken ct = default);
